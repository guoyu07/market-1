...
<form id="frmUser" name="frmUser" role="form" class="form-horizontal" action="${ctx}/area/add" method="post">
  ...
  <div class="modal-body">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-10">
              <input name="name" type="text"  id="name" class="form-control" placeholder="输入区域名称" value="${area.name}">
          </div>
      </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input name="remark" type="text" class="form-control"  placeholder="输入备注" value="${area.remark}">
      </div>
    </div>
