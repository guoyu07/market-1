...
<head>   <title>应用市场管理系统</title>
  ...
  <script type="text/javascript" src="${ctx}/resources/js/busi/sysManage/areaList.js?v=${deployVersion}"></script>
...
<div class="wrapper row-offcanvas row-offcanvas-left">
  ...
  <jsp:include page="../include/left.jsp">
    <jsp:param name="enName" value="areaManage" />
  </jsp:include>
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      <h1>区域管理</h1>
      <ucfPay:ContentHeaderTag enName="areaManage" />
    </section>
    ...
    <section class="content">
      <form id="frmQry" name="frmQry" role="form" action="" METHOD="post" class="form-horizontal">
        ...
        <div class="box-footer">
          ...
          <shiro:hasPermission name="sysManage:areaManage:CREATE">
              <%--<button id="btnExport" type="button" class="btn">导出用户</button>--%>
            <a href="/area/toAdd" type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i>添加区域</a>
