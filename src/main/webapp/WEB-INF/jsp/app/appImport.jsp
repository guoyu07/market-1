...
<form id="frmEdit" name="frmEdit" role="form" class="form-horizontal" action="${ctx}/app/fileImport" method="post">
    <input type="hidden" name="_method" id="_method" value="post"/>
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title" id="myModalLabel">批量导入应用</h4>
    </div>
    <div class="modal-body">
        <div class="form-group">
            <input type="hidden" id="appFile" name="appFile" value=""/>
            <label class="col-sm-4 control-label">应用文件：</label>
            <div class="col-sm-8">
                ...
                <br><a href="<c:url value="/resources/demo/app.xls"/>">下载应用文件示例</a>
            </div>
        </div>
    ...
    <div class="modal-footer">
        <shiro:hasPermission name="appManage:appControl:IMPORT">
